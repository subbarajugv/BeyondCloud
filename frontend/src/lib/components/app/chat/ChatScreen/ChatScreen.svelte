...
{:else if isServerLoading}
	...
	<ServerLoadingSplash />
{:else if serverStore.error && !serverStore.props}
	<ServerErrorSplash error={serverStore.error} />
{:else}
	<!-- Empty state / Welcome screen (works for both llama.cpp and Ollama) -->
	<div
	...
	>
		<div class="w-full max-w-[48rem] px-4">
			<div class="mb-8 text-center" in:fade={{ duration: 300 }}>
				<h1 class="mb-2 text-3xl font-semibold tracking-tight">BeyondCloud</h1>
