...
<svelte:head>
    <title>Register - BeyondCloud</title>
</svelte:head>
...
<div class="rounded-2xl border border-slate-700/50 bg-slate-800/50 p-8 shadow-2xl backdrop-blur-sm">
    <div class="mb-8 text-center">
        ...
        <p class="text-slate-400">Join BeyondCloud and start chatting</p>
    </div>
    ...
    <form onsubmit={handleSubmit} class="space-y-5">
        ...
        <button
            type="submit"
            disabled={isSubmitting}
            class="w-full rounded-lg bg-gradient-to-r from-emerald-600 to-emerald-500 px-4 py-3 font-semibold text-white shadow-lg transition-all hover:from-emerald-500 hover:to-emerald-400 hover:shadow-emerald-500/25 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:ring-offset-slate-800 disabled:cursor-not-allowed disabled:opacity-50"
        >
            {#if isSubmitting}
    ...
    <div class="mt-6 text-center">
        <p class="text-slate-400">
            ...
            <a href="/login" class="font-medium text-blue-400 transition-colors hover:text-blue-300">
                Sign in
            </a>
        </p>
    </div>
